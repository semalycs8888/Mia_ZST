...
gui:Category(Tool:getLocalizedText("Mia_狂暴战", "Mia_Warrior"))
    ...
    :Button({text = Tool:getLocalizedText("复制常用天赋字符串", "Copy Common Talent String"), key = "talent", width = 100, height = 30,onClick = function() CopyToClipboard("CgEArbixk/ZKwTdpZGVHeylmLAAAAAAAAAQjhxsYmhZWGMzCzMzYGmhZ22mZMzMLAzMzYmxywwMzMAAAIGbbDsAmgZYCMYDA") end})
